...
[bootstrap/stage5-print-nil-and-list-tail-qfc4.qf1](bootstrap/stage5-print-nil-and-list-tail-qfc4.qf1)
merges the nil branch with the tail-recursive two-element list printer. It is
generated by [tools/generate_stage5_print_nil_tail_qfc4.py](tools/generate_stage5_print_nil_tail_qfc4.py)
and assembled as a two-step qfc4 -> qfasm3 -> ELF pipeline with the focused
`qfasm-print-n272-ext.qf1` range extension. The generated ELF writes stdout
`()(a b)`.
[bootstrap/stage5-print-nil-and-nested-list-qfc4.qf1](bootstrap/stage5-print-nil-and-nested-list-qfc4.qf1)
...
the expected ELF checks that shape and exits `42`.
